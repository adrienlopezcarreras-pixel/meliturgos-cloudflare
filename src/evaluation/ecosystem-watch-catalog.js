...
const OFFICIAL = Object.freeze({
  ...
  similarwebTop: 'https://www.similarweb.com/top-websites/',
  trancoTop: 'https://tranco-list.eu/',
  majesticMillion: 'https://majestic.com/reports/majestic-million',
  lmarenaText: 'https://lmarena.ai/leaderboard/text',
  artificialAnalysis: 'https://artificialanalysis.ai/leaderboards/models',
  sweBench: 'https://www.swebench.com/',
  huggingFaceOpenLlm: 'https://huggingface.co/open-llm-leaderboard',
});
...
export const ECOSYSTEM_WATCH_TARGETS = Object.freeze([
  ...
  target('watch_source_reputation', 'Réputation et visibilité des sources web', 'source-intelligence',
    'latest website traffic popularity authority backlinks reputation ranking source quality Similarweb Tranco Majestic',
    ['research','provenance','source-ranking','reputation'],
    [OFFICIAL.similarwebTop, OFFICIAL.trancoTop, OFFICIAL.majesticMillion],
    { source_class: 'ranking-signal', verification_policy: 'POPULARITY_IS_NOT_TRUTH_PRIMARY_SOURCE_REQUIRED_FOR_FACTS' }),
  target('watch_ai_benchmarks', 'Benchmarks et classements IA', 'ai-benchmarks',
    'latest AI model benchmark leaderboard human preference coding agent intelligence open model quality cost latency',
    ['models','benchmark','coding','agents','open-models'],
    [OFFICIAL.lmarenaText, OFFICIAL.artificialAnalysis, OFFICIAL.sweBench, OFFICIAL.huggingFaceOpenLlm],
    { source_class: 'benchmark-signal', verification_policy: 'MULTI_BENCHMARK_PLUS_LOCAL_REPRODUCIBLE_TEST_BEFORE_PROMOTION' }),
