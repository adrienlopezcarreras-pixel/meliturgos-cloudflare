...
export function normalizeRegressionPolicy(policy = {}) {
  ...
  return {
    ...
    block_repeated_errors: policy.block_repeated_errors ?? policy.blockRepeatedErrors ?? DEFAULT_REGRESSION_POLICY.block_repeated_errors,
    require_evidence: policy.require_evidence ?? policy.requireEvidence ?? DEFAULT_REGRESSION_POLICY.require_evidence,
    require_source_sha: policy.require_source_sha ?? policy.requireSourceSha ?? DEFAULT_REGRESSION_POLICY.require_source_sha,
