...
export const ROADMAP_REGISTRY_REVISION = '2026-09-26.11';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P04', 'Capability Bus, outils et accès au code', [
    ...
    item('GEN2-15', 'Plugin SDK', 'DONE', 'Plugin SDK durable fusionné via #397: manifest/permissions, registre D1, identité manifest+artifact immuable, candidate→tested→active, activation unique, historique durable et rollback vers version vérifiée; tests de persistance après recréation adapter verts. Preuve runtime production exacte + redémarrage réel requise avant DONE_VERIFIED.', 'P1'),
