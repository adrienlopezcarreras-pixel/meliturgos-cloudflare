...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P14', 'Interface et expérience', [
    item('GEN2-54', 'Control Center / Mode complet', 'IN_PROGRESS', 'Control Center unifié relié aux APIs réelles, navigation mobile Plus peuplée et Compétences allégée. Audit vérité UI étendu: cartes LoRA/Windows/terminal démarrent en Vérification/Chargement; réponse LoRA partielle ne fabrique plus NEVER_RUN/BLOCKED/0-50/AUCUNE MESURE/UNCENSORED_WAITING/VERROUILLÉ; CapabilityBus sans liste est indisponible plutôt que vide; compteurs import ChatGPT absents restent —; ShardVault sans compteur ne devient plus 0 fragments. Tests vérité dédiés verts; preuve code full-candidate-ci 35859246933 et lora-runtime-pipeline-ci 35859247015 SUCCESS sur 389237d4ec37347b05efa953c30902cf63f82d6c. Reste à achever la migration des panneaux legacy vers une seule couche de présentation avant DONE_VERIFIED.', 'P0'),
    ...
    item('MEL-UI-05', 'État réel, pas de cartes factices', 'IN_PROGRESS', 'Vue d’ensemble et cartes secondaires durcies contre les faux états et faux zéros: métriques absentes restent —/Indisponible; activité distingue non chargé, indisponible et vrai zéro; LoRA, Windows et terminal n’affirment plus un état sans preuve; CapabilityBus absent ne vaut pas liste vide; compteurs import ChatGPT manquants ne valent pas 0; ShardVault sans nombre de fragments indique indisponible. Runtime navigateur reparsé après correction de l’échappement newline ShardVault. Preuves code: full-candidate-ci 35859246933 et lora-runtime-pipeline-ci 35859247015 SUCCESS sur 389237d4ec37347b05efa953c30902cf63f82d6c. Reste l’audit des derniers panneaux legacy pendant leur consolidation avant DONE_VERIFIED.', 'P0')
  ]),
