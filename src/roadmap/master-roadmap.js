...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-59', 'Build et release Windows', 'IN_PROGRESS', 'Pipeline Windows exact-SHA ajouté sur windows-latest: bundle canonique depuis assets/, ZIP déterministe, manifeste versionné avec SHA-256 par fichier et package, vérification fail-closed, signature Authenticode optionnelle uniquement via secrets PFX éphémères et artefact GitHub versionné. Reste avant DONE_VERIFIED: CI Windows réelle de cette branche, merge/déploiement du contrat puis exécution manuelle d’un release signé avec certificat configuré et validation installation/mise à jour sur PC Windows réel.', 'P2'),
  ...
  phase('P15', 'Release, migration et maturité finale', [
    ...
    item('GEN2-55', 'Data integrity / final maturity tests', 'IN_PROGRESS', 'system.integrity + system.maturity sont des audits read-only bornes couvrant migrations/tables/references/JSON/coherence temporelle, CapabilityBus et structure roadmap. Le workflow de release execute desormais les deux audits sur D1 production et verifie leurs invariants sans reparation automatique ni appel reseau. CI + deploiement live requis avant DONE_VERIFIED.', 'P1'),
