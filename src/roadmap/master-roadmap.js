...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('MEL-VOICE-01', 'Réveil Bonjour MEL / Allô MEL', 'DONE', 'Détection locale navigateur fusionnée via #440: Bonjour MEL / Allô MEL, normalisation accents/casse, commande inline ou fenêtre bornée 8 s, aucun prompt micro déclenché uniquement par wake-word, gestion visibilité et pause pendant interaction vocale manuelle. CI mel-voice-01-wake-word-ci et avatar browser motion vertes; validation navigateur réelle multi-session requise avant DONE_VERIFIED.', 'P1'),
