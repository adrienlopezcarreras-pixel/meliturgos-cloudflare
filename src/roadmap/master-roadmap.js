...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P04', 'Capability Bus, outils et accès au code', [
    ...
    item('GEN2-15', 'Plugin SDK', 'PARTIAL', 'Runtime/manifest/permissions + registre/versioning D1 et rollback sont implémentés; raccorder le chargement vérifié de l’artefact exact au runtime puis prouver installation/activation/restart de bout en bout avant DONE_VERIFIED.', 'P1'),
