...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android 0.6.0 sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal/Complet, pairing sans persistance du mot de passe, jeton device Keystore, chat/sync ACK/micro Whisper/fichiers HTTPS fail-closed, avatar MEL natif et icône launcher. Arrière-plan: heartbeat WorkManager toutes les 15 min sous contrainte réseau, notifications opt-in, alerte session expirée, annulation à la déconnexion et aucune capture micro cachée. Mode Complet 0.6.0: auto-diagnostic authentifié affichant version app, session, heartbeat, mode, SDK, version acceptée par le backend, device ID serveur, heure serveur et stockage Keystore. Preuves: android-apk-build 35866958493 SUCCESS sur 5d5dc9d4e259e534eb97ae403575b3e6caea8ca0; UI émulateur 35866804807 SUCCESS sur 2c9ba7f46309cb59b968fa89e08b6c844c24e17e, puis seul le contrat versionCode a changé entre ce SHA et la candidate finale. Reste validation sur appareil Android réel: auth, fichier, micro, Normal/Complet, avatar/ergonomie, heartbeat, notifications et auto-diagnostic avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique et pipeline release signé préparé. Debug 0.6.0: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité et artefact vérifiés; android-apk-build 35866958493 SUCCESS sur 5d5dc9d4e259e534eb97ae403575b3e6caea8ca0, artefact GitHub 10751624713; APK package fr.veriteinterdite.mel, versionCode 9/versionName 0.6.0, minSdk 26, targetSdk 35, SHA-256 62e36a9e78dcdbc960c0bdcc16a3a3837621c832a40613084d042cbfc40b239a. Release: keystore exclusivement via secrets GitHub, aucune clé dans le dépôt, exact-SHA guard exigeant le head de release/mel-hardware-v0.1.0 avant signature, apksigner/zipalign/package et suppression du keystore runner. Reste une vraie exécution signée avec keystore protégé sur release canonique et validation appareil réel avant DONE_VERIFIED.', 'P1'),
