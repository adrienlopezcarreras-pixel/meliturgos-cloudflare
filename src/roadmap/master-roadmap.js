...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P15', 'Release, migration et maturité finale', [
    ...
    item('GEN2-63', 'Règle NON-IDLE / continue-when-blocked', 'DONE', 'Invariant exécutable fusionné via #404: les blocages ne stoppent plus l avancée tant qu une tâche actionnable reste; sélection déterministe et état incohérent fail-closed. CI gen2-63 verte.', 'P1'),
