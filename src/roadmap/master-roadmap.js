...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P08', 'Connecteurs et web', [
    ...
    item('GEN2-37', 'Web / recherche', 'DONE_VERIFIED', 'Recherche sourcée + qualité/provenance certifiées en production. Release 36150649958 sur SHA 231b83e5009bf86af538d802f12e46b339252c70: endpoint réel /api/gen2/web/research, seed officiel Cloudflare strictement scoped, source directe HIGH_PROVENANCE/provenance complète et marqueur GEN2-37 PRODUCTION_VERIFIED.', 'P1'),
  ...
  phase('P12', 'Résilience, sauvegarde et indépendance', [
    ...
    item('GEN2-48', 'Restore / disaster recovery', 'DONE_VERIFIED', 'Recovery drill isolé certifié en production sans activation: release 36150649958 sur SHA 231b83e5009bf86af538d802f12e46b339252c70, snapshot system-20260925145625240 vérifié, reconstruction logique D1, revalidation runtime/R2, teardown complet, production_access_used=false et activation_performed=false.', 'P1'),
