...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal / Complet, pairing sans persistance du mot de passe, jeton device Keystore, heartbeat, chat/sync ACK/micro Whisper, fichiers et HTTPS fail-closed. 0.3.0/0.3.1: OpenDocument, upload privé, analyse texte, fallback textuel borné <=512 Ko si backend ancien, binaires fail-closed, panneau Complet Synchroniser + Professor. 0.4.0: véritable avatar MEL vectoriel natif (visage féminin brun + halo techno), avatar dans connexion/chargement/erreur/conversation et icône launcher. Preuve 0.4.0: PR #171 fusionnée; android-apk-build 35857944756 SUCCESS sur 8b02d756af302264ef6d484d6bd257c5abc7d0cb. Reste validation Android réel: auth, fichier, micro, Normal/Complet, avatar/ergonomie et arrière-plan/notifications avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique renforcé et pipeline release signé préparé. Debug: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité et artefact vérifiés. Release: keystore exclusivement via secrets GitHub/variables environnement, aucune clé dans le dépôt, build manuel borné à release/mel-hardware-v0.1.0 ou tag android-v*, garde exact-SHA release, apksigner + zipalign + package, suppression du keystore runner. Preuve debug 0.4.0: run 35857944756 SUCCESS, artefact 10748204322; APK versionCode 5 / versionName 0.4.0, minSdk 26, targetSdk 35, SHA-256 55ec9cdb59701bb9f0be59b052a5d2d1c1af081b7065882b3994cef320578008. Pipeline signé non encore certifié car aucune exécution avec keystore protégé sur release canonique n’a été observée. Reste vraie signature release + validation appareil réel avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P14', 'Interface et expérience', [
    item('GEN2-54', 'Control Center / Mode complet', 'IN_PROGRESS', 'Control Center unifié relié aux APIs réelles, navigation mobile Plus peuplée et Compétences allégée. Nouveau lot vérité UI: cartes LoRA/Windows/terminal démarrent en état Vérification/Chargement, les échecs marquent explicitement Indisponible, et une réponse LoRA partielle ne fabrique plus NEVER_RUN/BLOCKED/0-50/AUCUNE MESURE/UNCENSORED_WAITING/VERROUILLÉ. Preuves exactes: full-candidate-ci 35858256187 et lora-runtime-pipeline-ci 35858256191 SUCCESS sur d8f74113ef4b53abec2d70de1ed7117791473f5e; unicity, hardware probe, teacher smoke et capture preview également verts. Reste à achever la migration des panneaux legacy vers une seule couche de présentation avant DONE_VERIFIED.', 'P0'),
    ...
    item('MEL-UI-05', 'État réel, pas de cartes factices', 'IN_PROGRESS', 'Vue d’ensemble et cartes secondaires durcies contre les faux états: métriques absentes restent —/Indisponible; activité distingue non chargé, indisponible et vrai zéro; LoRA ne transforme plus les champs manquants en Jamais lancé, BLOCKED, 0/50, Aucune mesure, UNCENSORED_WAITING ou VERROUILLÉ; Windows et terminal n’affirment plus une absence avant réponse API. Tests control-center-truthful-status + full-candidate-ci 35858256187 + lora-runtime-pipeline-ci 35858256191 verts sur d8f74113ef4b53abec2d70de1ed7117791473f5e. Reste l’audit des derniers panneaux legacy lors de leur consolidation avant DONE_VERIFIED.', 'P0')
  ]),
