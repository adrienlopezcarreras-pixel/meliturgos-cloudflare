...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('MEL-MEM-05', 'Indexation complète messages et pièces jointes', 'IN_PROGRESS', 'Collector 0.6.4: backfill historique idempotent, capture des URL de pièces jointes, récupération bornée des octets, stockage privé R2 avec SHA-256 et provenance, extraction/indexation réelle du texte quand supportée, couverture indexed_descriptors exposée. Reste à valider le backfill sur l’historique réel et étendre les parseurs aux PDF/images/autres binaires avant DONE_VERIFIED', 'P0'),
