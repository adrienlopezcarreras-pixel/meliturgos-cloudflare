...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('MEL-MEM-03', 'Export mémoire portable et lisible', 'DONE_VERIFIED', 'Preuve production 2026-09-25 sur 04a45569: export complet 4453/4453 records (379 memories, 536 conversations, 3538 archive_messages), manifeste SHA-256 et checksum global valides, payload ~5.60 MB, puis memory.export.verify a accepté exactement le snapshot exporté.', 'P1'),
