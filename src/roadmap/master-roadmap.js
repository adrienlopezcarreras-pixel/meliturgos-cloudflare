...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P04', 'Capability Bus, outils et accès au code', [
    ...
    item('GEN2-15', 'Plugin SDK', 'PARTIAL', 'SDK/runtime + registre D1 + loader serveur couvrent désormais install candidate, chargement épinglé, activation avec preuves, restauration explicite d’une version durable ACTIVE après redémarrage, execute/health/disable et rollback vers une version cible résolue/validée avant désactivation de la source. Les échecs de restore désactivent l’état durable stale. Reste à raccorder ce loader au bootstrap runtime principal et à un resolver d’artefacts serveur concret avant DONE.', 'P1'),
