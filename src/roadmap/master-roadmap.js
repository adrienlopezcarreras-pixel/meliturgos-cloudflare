...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-58', 'Build et release Android', 'DONE', 'Pipelines Android debug et release signé exact-SHA déjà préparés/promus avec keystore via secrets, apksigner/zipalign/package et nettoyage runner. Installation/exécution signée réelle 0.6.5 requise avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P12', 'Résilience, sauvegarde et indépendance', [
    item('GEN2-47', 'Backups / export système', 'DONE', 'Backups système complets: snapshots D1, chiffrement AES-GCM, copie bornée des octets R2, SHA-256 après copie, manifest source/backup, restore isolé byte-for-byte et nettoyage fail-closed fusionnés via #417/#436. Gates gen2-47-r2-byte-backup-ci et MEL-RES-05 encrypted backup CI vertes. Drill live production requis avant DONE_VERIFIED.', 'P1'),
