...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('MEL-VOICE-01', 'Réveil Bonjour MEL / Allô MEL', 'PARTIAL', 'Détection locale navigateur fusionnée: Bonjour MEL / Allô MEL, normalisation FR, commande inline ou fenêtre bornée 8 s, démarrage auto uniquement si permission micro déjà accordée, aucune requête réseau pour le wake-word. Reste validation navigateur réel et extension compagnon selon plateforme avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-26', 'PWA', 'PARTIAL', 'Manifest installable + theme-color + cache statique v8 + pré-cache public borné fusionnés; HTML privé et API restent exclus du cache. Reste preuve d installation/offline réelle sur navigateur/appareil avant DONE_VERIFIED.', 'P2'),
