...
export const ROADMAP_REGISTRY_REVISION = '2026-09-25.9';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P13', 'Évaluation et amélioration continue', [
    ...
    item('MEL-EVAL-01', 'Suites de benchmark conversation / code / recherche / mémoire', 'IN_PROGRESS', 'Branche roadmap/stable-eval-suite-20260925 : contrat stable mel-core-stable-eval-v1 couvrant conversation/code/search/memory, fingerprint déterministe, évaluateurs injectables, score pondéré par domaine, critical failures, latence, comparaison baseline/candidat et gate de non-régression par moyenne + domaine. Branchement aux watches runtime et preuve CI complète requis avant DONE_VERIFIED.', 'P1'),
