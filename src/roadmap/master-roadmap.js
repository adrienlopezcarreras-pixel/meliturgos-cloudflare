...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.03';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android refondu sur candidate: Jetpack Compose + Material 3, identité visuelle MEL, écran de connexion dédié, modes Normal / Complet explicites et propagés au backend, pairing propriétaire sans persistance du mot de passe, jeton device hashé serveur + chiffré Android Keystore, heartbeat post-pairing obligatoire, chat canonique, sync ACK, micro -> Whisper -> chat, révocation et HTTPS fail-closed. Preuves: PR #167 fusionnée, contrats Android/API et build APK verts dans run 35848145419 sur 02fb13e5e10f32bc26f8f998872e25a2dc51e79e. Reste validation appareil Android réel, comportement micro réel/service de fond/notifications avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline CI APK debug canonique renforcé: tests contrats Android/API avant build, Java 17, Gradle 8.9, Android SDK 35, Compose/Material 3, package fr.veriteinterdite.mel et activité de lancement vérifiés puis artefact uploadé. Preuve candidate: run 35848145419 SUCCESS sur 02fb13e5e10f32bc26f8f998872e25a2dc51e79e; APK versionCode 2 / versionName 0.2.0, minSdk 26, targetSdk 35, SHA-256 cec6ef61af4a4d08173b29a58f2ff947995e67cc3f47e8c6f93e286d0dc51632. Reste signature release par secret protégé, pipeline release versionné et validation sur appareil réel avant DONE_VERIFIED.', 'P1'),
