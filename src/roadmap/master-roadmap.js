...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P06', 'Module Lab, évolution et apprentissage', [
    ...
    item('MEL-EVOL-05', 'Skill Registry durable', 'IN_PROGRESS', 'Skill Registry portable mel.skill-registry/v1 et store D1 durable déjà fusionnés; candidate runtime actuelle ajoute bridge de preuves Module Lab/LearningEngine, capacités skill.* bornées, persistance/rollback, export portable et smoke production read-only skill.list. Reste avant DONE_VERIFIED: CI exacte, merge puis preuve live CapabilityBus -> D1 sur production.', 'P1'),
