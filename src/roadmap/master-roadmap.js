...
export const ROADMAP_REGISTRY_REVISION = '2026-09-26.12';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('GEN2-24', 'Documents', 'DONE', 'Extraction/indexation document bornée + durcissement PDF/DOCX fusionnés via #310/#414: timeout parser, propagation abort, erreurs normalisées et garde-fou overflow pages; CI gen2-24-documents-ci 36227303563 verte. Preuve sur corpus réel hétérogène requise avant DONE_VERIFIED.', 'P1'),
