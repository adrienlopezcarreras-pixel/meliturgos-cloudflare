...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.11';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android 0.6.3 sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal/Complet, pairing sans persistance du mot de passe, jeton device Keystore, chat/sync ACK/micro Whisper/fichiers HTTPS fail-closed, avatar MEL natif et icône launcher. Arrière-plan: heartbeat WorkManager toutes les 15 min sous contrainte réseau, notifications opt-in, alerte session expirée, annulation à la déconnexion et aucune capture micro cachée. Mode Complet: auto-diagnostic authentifié + copie presse-papiers; validation téléphone intégrée Tester Normal, Tester fichier et Tester arrière-plan. Lecture URI bornée réellement à 25 Mo. 0.6.3 ajoute des preuves réelles persistées dans le rapport uniquement après succès: Micro réel: OK après transcription + réponse MEL, Fichier réel: OK après traitement réussi. Preuves post-merge sur d3943dbe4a0bea00a312862ffb78241da0fb0d30: android-apk-build 35883169753 SUCCESS et android-emulator-ui-test 35883169746 SUCCESS, captures UI incluses; le commit candidate suivant ne touche qu à ShardVault. Preuve appareil réel 0.6.1 le 2026-09-23: Android SDK 33, Session OK, Heartbeat OK, Mode Complet, backend compatible, device reconnu et Keystore confirmé. Reste validation réelle 0.6.3: Tester Normal, Tester fichier, Tester arrière-plan, micro matériel puis contrôle ergonomie/avatar avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique et pipeline release signé préparé. Debug 0.6.3: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité, tests UI émulateur, captures et artefact vérifiés; android-apk-build 35883169753 SUCCESS et android-emulator-ui-test 35883169746 SUCCESS sur d3943dbe4a0bea00a312862ffb78241da0fb0d30; artefact APK 10762220562 et preuve émulateur 10760439758; APK fr.veriteinterdite.mel versionCode 12/versionName 0.6.3, minSdk 26, targetSdk 35, SHA-256 95531cf3f469d84ba02f92d47012e476b105bffc850f5cbfc3555b051139c90e. Installation/exécution réelle 0.6.1 déjà confirmées sur Android SDK 33; 0.6.3 permet maintenant d inscrire dans le rapport les succès réels micro/fichier et contient les probes Normal/arrière-plan. Release: keystore exclusivement via secrets GitHub, aucune clé dans le dépôt, exact-SHA guard avant signature, apksigner/zipalign/package et suppression du keystore runner. Reste vraie exécution signée + validation appareil réel 0.6.3 avant DONE_VERIFIED.', 'P1'),
