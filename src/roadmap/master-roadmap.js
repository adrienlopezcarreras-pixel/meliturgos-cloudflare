...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('MEL-VOICE-01', 'Réveil Bonjour MEL / Allô MEL', 'PARTIAL', 'Réveil local navigateur fusionné via #440: Bonjour MEL / Allô MEL, normalisation FR, commande inline ou fenêtre bornée 8 s, aucun appel réseau pour la détection et auto-écoute seulement si permission micro déjà accordée. Reste validation navigateur réel et extension compagnon selon plateforme avant DONE_VERIFIED.', 'P1'),
    ...
    item('MEL-AVATAR-02', 'Talking avatar lip-sync', 'PARTIAL', 'Socle lip-sync fusionné via #447: contrat provider-neutral niveaux 0–3, provider interchangeable, fallback local zéro coût borné et rendu léger respectant prefers-reduced-motion. Reste brancher/valider un vrai provider ou signal audio/visème avant DONE_VERIFIED.', 'P2'),
