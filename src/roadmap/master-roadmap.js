...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('MEL-MEM-03', 'Export mémoire portable et lisible', 'IN_PROGRESS', 'Branche roadmap/memory-portable-export-20260925 : /api/export et memory.export conservent les collections lisibles mais ajoutent manifeste versionné, DB schema version, SHA-256 par collection, checksum global et complétude explicite; memory.export.verify détecte corruption et export tronqué. CI et validation d’un export réel restent requises avant DONE_VERIFIED.', 'P1'),
