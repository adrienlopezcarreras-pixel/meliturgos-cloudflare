...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P02', 'Conversation, contexte et continuité', [
    ...
    item('MEL-CONTEXT-02', 'Contexte long avec compression sans perte de décisions', 'IN_PROGRESS', 'Implémentation fusionnée par PR #314 et incluse dans le SHA production e749551d6c2786c225d5194a5a3556e4f47c84fd; 9/9 tests de contexte long verts dans le run de release 36164971157, dont décision au milieu d un message tronqué et corrections contradictoires. Reste uniquement une preuve runtime authentifiée sur une conversation longue réelle avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-28', 'Windows Companion runtime / agent', 'IN_PROGRESS', 'Runtime Windows réel déjà fusionné: heartbeat, capture écran, computer-use borné, file commandes/résultats, appairage à usage unique, jeton DPAPI, révocation et refus replay. Le packaging exact-SHA GEN2-59 est désormais fusionné par PR #365. Reste essentiellement la validation sur PC Windows réel du compagnon et du cycle installation/mise à jour avant DONE_VERIFIED.', 'P0'),
    item('GEN2-59', 'Build et release Windows', 'IN_PROGRESS', 'Pipeline Windows exact-SHA build/sign/verify fusionné par PR #365 dans le main et inclus dans le SHA production e749551d6c2786c225d5194a5a3556e4f47c84fd. Reste la validation Windows réelle: build signé, installation, exécution et cycle de mise à jour avant DONE_VERIFIED.', 'P2'),
  ...
  phase('P13', 'Évaluation et amélioration continue', [
    ...
    item('MEL-EVAL-01', 'Suites de benchmark conversation / code / recherche / mémoire', 'DONE', 'Suite stable conversation/code/search/memory complétée par PR #426 avec watch durable exact-SHA: première exécution complète établit la baseline, les candidats suivants ne la remplacent que si le gate anti-régression est promotable; régressions et évaluateurs manquants restent observables sans promotion silencieuse. Gate mel-eval-01-stable-watch-ci 36227895092 vert. Preuve runtime production requise avant DONE_VERIFIED.', 'P1'),
