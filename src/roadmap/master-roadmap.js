...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P11', 'Sécurité, audit et gouvernance', [
    ...
    item('MEL-SEC-03', 'Supply-chain / dépendances / CI', 'IN_PROGRESS', 'SBOM runtime + lockfile/registry gate + attestation exacte commit/lockfile/SBOM/audit et artefact CI sont présents. La promotion production exige désormais explicitement release_eligible=true; une panne registry reste attestée mais bloque fail-closed la promotion. Tests ciblés requis puis déploiement/preuve release avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P15', 'Release, migration et maturité finale', [
    ...
    item('GEN2-55', 'Data integrity / final maturity tests', 'PARTIAL', 'system.integrity + system.maturity livrés comme audits read-only bornés: migrations/tables/références/JSON/cohérence temporelle, contrats CapabilityBus et structure roadmap. Aucun réseau, aucune réparation automatique, aucun contenu utilisateur exposé. Après merge: déploiement immédiat puis smoke D1 production avant DONE_VERIFIED.', 'P1'),
