...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('MEL-VOICE-02', 'Conversation audio transcrite en mémoire', 'DONE', 'Pipeline vocal vers mémoire déjà livré: clic avatar, reconnaissance navigateur ou MediaRecorder, transcription serveur, provenance bornée, chat persistant, audio brut éphémère et synchronisation mémoire. Validation Android/appareil réel requise avant DONE_VERIFIED.', 'P0'),
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'DONE', 'Runtime Android natif 0.6.5 déjà promu via #212 avec Compose/Material 3, pairing sécurisé, chat/sync, micro Whisper, fichiers HTTPS bornés, heartbeat WorkManager et probes de validation; CI build/emulator/full-candidate vertes. Validation appareil réel 0.6.5 requise avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'DONE', 'Pipelines Android debug et release signé exact-SHA déjà préparés/promus; keystore via secrets, apksigner/zipalign/package et suppression du keystore runner. Installation/exécution signée réelle 0.6.5 requise avant DONE_VERIFIED.', 'P1'),
