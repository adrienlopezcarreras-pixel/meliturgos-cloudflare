...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P06', 'Module Lab, évolution et apprentissage', [
    ...
    item('MEL-EVOL-05', 'Skill Registry durable', 'IN_PROGRESS', 'Composition root D1, persistance/restauration/rollback et snapshot portable déjà intégrés; candidate finale ajoute bridge de preuves Module Lab/LearningEngine, capacités skill.* bornées, export portable et smoke production read-only skill.list. CI ciblée + full suite vertes sur le lot réconcilié précédent; reste le merge exact sur ce main puis preuve live CapabilityBus -> D1 avant DONE_VERIFIED.', 'P1'),
