...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('MEL-MEM-05', 'Indexation complète messages et pièces jointes', 'IN_PROGRESS', 'Messages fichier-seul + métadonnées recherchables + enrichissement idempotent des doublons implémentés; Collector 0.6.3 prépare un backfill historique une fois la collecte primaire terminée. Reste à valider ce backfill sur l’historique réel et indexer le contenu binaire quand les octets existent', 'P0'),
