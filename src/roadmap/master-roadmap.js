...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.05';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android refondu sur candidate: Jetpack Compose + Material 3, identité visuelle MEL, connexion dédiée, modes Normal / Complet, pairing sans persistance du mot de passe, jeton device Keystore, heartbeat post-pairing, chat/sync ACK/micro Whisper, HTTPS fail-closed. Lot 0.3.0: sélecteur OpenDocument, upload privé device-token via moteur canonique files/upload, analyse des aperçus texte, panneau Complet Synchroniser + Professor. Lot 0.3.1: si le backend déployé est plus ancien et renvoie 404 sur la route fichier Android, fallback borné uniquement aux fichiers textuels <=512 Ko: décodage local puis analyse via le chat déjà authentifié; les binaires/non-textes restent fail-closed. Preuves: PR #167, #168 et #169 fusionnées; run Android canonique 35851622122 SUCCESS sur b64f407d4199bdcee202cf2da3670517e8ea153a. Reste validation sur Android réel: auth, fichier texte/binaire, micro, Normal/Complet et arrière-plan/notifications avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline CI APK debug canonique renforcé: contrats Android/API avant build, Java 17, Gradle 8.9, Android SDK 35, Compose/Material 3, package fr.veriteinterdite.mel et activité de lancement vérifiés, artefact uploadé; changements android-companion, android API et file-upload déclenchent la CI. Preuve candidate 0.3.1: run 35851622122 SUCCESS sur b64f407d4199bdcee202cf2da3670517e8ea153a, artefact 10744939974; APK versionCode 4 / versionName 0.3.1, minSdk 26, targetSdk 35, SHA-256 e3ced7f4999f674fba9f7f3d8c4cc96fa96074985b377e9f2718de429d2f5ed2. Reste signature release par secret protégé, pipeline release versionné et validation appareil réel avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P14', 'Interface et expérience', [
    item('GEN2-54', 'Control Center / Mode complet', 'IN_PROGRESS', 'Control Center unifié relié à des APIs réelles, navigation mobile « Plus » peuplée et Compétences allégée via cache. Nouveau durcissement vérité UI: les métriques dashboard/roadmap/activité absentes ne sont plus transformées en faux zéros; le panneau Activité distingue désormais journal non chargé, état indisponible et vrai zéro observé. Preuves candidate: full-candidate-ci 35850210580 et lora-runtime-pipeline-ci 35850210604 verts sur efbda7d8ce449c3d0efa0324cc84f6f1e6fefc3a. Reste à auditer les autres cartes secondaires et achever la migration vers une seule couche de présentation avant DONE_VERIFIED.', 'P0'),
    ...
    item('MEL-UI-05', 'État réel, pas de cartes factices', 'IN_PROGRESS', 'Vue d’ensemble reliée à /api/gen2/dashboard-summary avec états calculés. Fallback « Diagnostic requis » conservé; métriques capabilities/roadmap inconnues affichées « — » ou « État indisponible » au lieu de 0, et Activité n’affirme plus « aucun travail/aucune trace » quand les données ne sont simplement pas chargées. Preuves candidate: full-candidate-ci 35850210580, lora-runtime-pipeline-ci 35850210604 et tests control-center-truthful-status verts sur efbda7d8ce449c3d0efa0324cc84f6f1e6fefc3a. Reste l’audit exhaustif des cartes secondaires et des autres compteurs avant DONE_VERIFIED.', 'P0')
  ]),
