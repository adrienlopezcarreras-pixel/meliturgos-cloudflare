...
export const ROADMAP_REGISTRY_REVISION = '2026-09-25.11';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P05', 'Multi-IA, .augmentio et Council', [
    ...
    item('MEL-COUNCIL-02', 'Critiques indépendantes + synthèse MEL', 'IN_PROGRESS', 'Branche roadmap/council-independent-critiques-20260925 : les rôles architecture/sécurité/tests/produit existaient déjà; ajout d’une matrice explicite des critiques, fournisseurs assignés/répondants, fallbacks, couverture des rôles et digest déterministe lié à l’entrée de synthèse MEL. CI complète et intégration de la preuve au handoff Teacher requises avant DONE_VERIFIED.', 'P1'),
