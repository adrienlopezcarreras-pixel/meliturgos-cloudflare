...
export const ROADMAP_REGISTRY_REVISION = '2026-09-25.10';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P15', 'Release, migration et maturité finale', [
    ...
    item('GEN2-60', 'Completion matrix', 'IN_PROGRESS', 'Branche roadmap/completion-matrix-20260925 : générateur canonique déjà existant réconcilié avec la roadmap, ajout révision source, fingerprint déterministe, taux DONE_VERIFIED, séparation BLOCKED_HUMAN/BLOCKED_EXTERNAL et rendu Markdown explicite des actions humaines. CI complète et intégration finale du payload restent requises avant DONE_VERIFIED.', 'P2'),
