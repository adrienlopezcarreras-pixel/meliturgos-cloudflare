...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P08', 'Connecteurs et web', [
    ...
    item('MEL-CONN-01', 'WordPress Vérité Interdite', 'DONE', 'WordPress public isolé livré via #441/#445/#456: scope PUBLIC_ONLY, lecture REST posts/pages/search bornée, chat public, CORS limité au site, aucun accès D1 ou mémoire privée, prompts et sources bornés, CI publique et full suite vertes. Preuve live sur le site requise avant DONE_VERIFIED.', 'P3'),
  ...
  phase('P09', 'Voix, avatar et multimodal', [
    ...
    item('MEL-AVATAR-02', 'Talking avatar lip-sync', 'DONE', 'Lip-sync provider-neutral fusionné via #447: provider interchangeable, fallback local zéro coût borné, ouverture de bouche légère et reduced-motion. CI lip-sync, avatar browser motion et Professor UI audit vertes. Validation visuelle réelle requise avant DONE_VERIFIED.', 'P2'),
    item('MEL-AVATAR-03', 'Tenue/identité visuelle moderne de MEL', 'DONE', 'Identité visuelle canonique fusionnée via #460: une identité MEL stable sur huit thèmes, costume et contexte comme metadata de présentation uniquement, fallback moderne neutre futuriste. CI mel-avatar-03-identity-ci verte. Validation visuelle réelle requise avant DONE_VERIFIED.', 'P2'),
  ]),
  ...
  phase('P12', 'Résilience, sauvegarde et indépendance', [
    item('GEN2-47', 'Backups / export système', 'DONE', 'Snapshots D1 complets + inventaire R2 automatisés et vérifiés; chiffrement AES-GCM, copie bornée des octets R2, SHA-256 après copie, manifest source/backup, restore isolé byte-for-byte et nettoyage fail-closed fusionnés via #417/#436. Gates gen2-47-r2-byte-backup-ci et MEL-RES-05 encrypted backup CI vertes. Drill live production requis avant DONE_VERIFIED.', 'P1'),
    ...
    item('MEL-RES-04', 'Cold standby autorisé', 'DONE', 'Cold standby manuel livré via #307/#449: préparation owner-approved, recovery drill isolé, destination chiffrée autorisée, adaptateur cold object provider-neutral, copie readback SHA-256 et aucun failover automatique. Preuve live sur destination froide réelle requise avant DONE_VERIFIED.', 'P2'),
