...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline CI APK debug installable opérationnel: Java 17, Gradle 8.9, Android SDK 35, package fr.veriteinterdite.mel vérifié, artefact run 35842980296 sur f076f8963820346ec278db00828e550845bcbdef; APK SHA-256 b54578f595a87a57d2b67196ed9598d086af735614f11ad7bdd301abbf8ad26a. Pairing propriétaire transitoire sans persistance du mot de passe, jeton Keystore, micro -> Whisper -> chat. Reste signature release par secret protégé, pipeline versionné et validation sur appareil réel avant DONE_VERIFIED.', 'P1'),
  ...
  phase('P14', 'Interface et expérience', [
    item('GEN2-54', 'Control Center / Mode complet', 'IN_PROGRESS', 'Control Center unifié désormais relié à un résumé système factuel: état global OK/WARN/ERROR dérivé de la santé CapabilityBus, des blocages roadmap et de l’identité exacte du déploiement; cartes d’accueil alimentées par composants API réels et navigation mobile « Plus » peuplée. Ouverture Compétences allégée via cache, refresh santé réel conservé sur action explicite. Preuves candidate: full-candidate-ci 35844893515 et lora-runtime-pipeline-ci 35844893604 verts sur 55a2a47968ed341ec3debe5e6d012876618814a0. Reste à poursuivre la migration des panneaux legacy restants vers cette seule surface avant DONE_VERIFIED.', 'P0'),
