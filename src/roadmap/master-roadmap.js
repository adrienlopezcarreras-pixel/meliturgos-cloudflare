...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P06', 'Module Lab, évolution et apprentissage', [
    ...
    item('MEL-EVOL-05', 'Skill Registry durable', 'IN_PROGRESS', 'Persistance D1 durable et câblage runtime production fusionnés par PR #330 puis #356: snapshots versionnés, activation/rollback, checksum SHA-256, validation de schéma, isolation par registry_key et restauration après redémarrage. Reste: persister un vrai Skill Registry sur D1 production puis prouver restauration et rollback runtime avant DONE_VERIFIED.', 'P1'),
