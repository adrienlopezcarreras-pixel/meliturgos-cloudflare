...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.09';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android 0.6.1 sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal/Complet, pairing sans persistance du mot de passe, jeton device Keystore, chat/sync ACK/micro Whisper/fichiers HTTPS fail-closed, avatar MEL natif et icône launcher. Arrière-plan: heartbeat WorkManager toutes les 15 min sous contrainte réseau, notifications opt-in, alerte session expirée, annulation à la déconnexion et aucune capture micro cachée. Mode Complet: auto-diagnostic authentifié affichant version app, session, heartbeat, mode, SDK, version acceptée par le backend, device ID serveur, heure serveur et stockage Keystore; 0.6.1 ajoute Copier diagnostic via presse-papiers Android. Preuves canoniques: android-apk-build 35869689183 SUCCESS, android-emulator-ui-test 35869689172 SUCCESS et canonical-branch-unicity 35869689104 SUCCESS sur b78d6da6ae12bd78798d32d369a4699aadfb2c94. Preuve appareil réel fournie le 2026-09-23: Android SDK 33, Session OK, Heartbeat OK, Mode Complet actif, backend acceptant 0.6.1, device reconnu par le serveur et jeton local Keystore confirmé; le rapport a été produit et copié depuis l app. Reste validation réelle ciblée: mode Normal, envoi fichier, micro, notifications/heartbeat arrière-plan et contrôle ergonomie/avatar avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique et pipeline release signé préparé. Debug 0.6.1: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité, tests UI émulateur et artefact vérifiés; android-apk-build 35869689183 SUCCESS et android-emulator-ui-test 35869689172 SUCCESS sur b78d6da6ae12bd78798d32d369a4699aadfb2c94; artefact APK 10754048385 et preuve émulateur 10754198819; APK fr.veriteinterdite.mel versionCode 10/versionName 0.6.1, minSdk 26, targetSdk 35, SHA-256 7229e2d71be258f8bc6ebc7c864cd3e95bd738bc05322f1af58e0841970a4516. Installation et exécution sur appareil Android réel SDK 33 confirmées le 2026-09-23 avec session/heartbeat/backend 0.6.1/Keystore OK. Release: keystore exclusivement via secrets GitHub, aucune clé dans le dépôt, exact-SHA guard exigeant le head de release/mel-hardware-v0.1.0 avant signature, apksigner/zipalign/package et suppression du keystore runner. Reste une vraie exécution signée avec keystore protégé et les tests réels fichier/micro/notifications avant DONE_VERIFIED.', 'P1'),
