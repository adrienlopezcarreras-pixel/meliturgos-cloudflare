...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P11', 'Sécurité, audit et gouvernance', [
    ...
    item('MEL-OBS-01', 'Traçage requête bout en bout / request_id', 'IN_PROGRESS', 'Branche roadmap/core-request-observability-20260925 : corréler un request_id unique de la frontière HTTP jusqu’au CapabilityBus, exposer durée/référence dans les réponses Core et structurer les erreurs terminales; fusion + CI + preuve production encore requises avant DONE_VERIFIED.', 'P0'),
