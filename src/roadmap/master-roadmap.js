...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android 0.6.4 sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal/Complet, pairing sans persistance du mot de passe, jeton device Keystore, chat/sync ACK/micro Whisper/fichiers HTTPS fail-closed, avatar MEL natif et icône launcher. Arrière-plan: heartbeat WorkManager toutes les 15 min sous contrainte réseau, notifications opt-in, alerte session expirée, annulation à la déconnexion et aucune capture micro cachée. Validation téléphone intégrée: Tester Normal, Tester fichier, Tester arrière-plan; lecture URI réellement bornée à 25 Mo; rapport copiable avec Micro réel: OK et Fichier réel: OK uniquement après succès réels. 0.6.4 corrige le contraste sombre (MelInk imposé sur surfaces/cartes), synchronise la version du harness et plafonne le panneau Complet à 340 dp avec défilement interne afin de garder la conversation et le composeur accessibles. Preuves post-merge canoniques sur 53840a553edc660cca712698a7c892e355767fa6: android-apk-build 35890454120 SUCCESS et android-emulator-ui-test 35890454094 SUCCESS avec captures réelles; inspection visuelle confirme connexion lisible et Mode Complet avec champ Message, Fichier, Micro et Envoyer visibles. Preuve appareil réel 0.6.1 le 2026-09-23: Android SDK 33, Session OK, Heartbeat OK, Mode Complet, backend compatible, device reconnu et Keystore confirmé. Reste validation réelle 0.6.4 des probes Normal/fichier/arrière-plan et du micro matériel avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique et pipeline release signé préparé. Debug 0.6.4: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité, tests UI émulateur, captures et artefact vérifiés; android-apk-build 35890454120 SUCCESS et android-emulator-ui-test 35890454094 SUCCESS sur 53840a553edc660cca712698a7c892e355767fa6; artefact APK 10764895878 et preuve émulateur 10765390493; APK fr.veriteinterdite.mel versionCode 13/versionName 0.6.4, minSdk 26, targetSdk 35, SHA-256 cba2ad4dfd219ba161ef05512b48035d1636bb01a4145f4323f97569a6fa7d77. Installation/exécution réelle 0.6.1 déjà confirmées sur Android SDK 33; la 0.6.4 regroupe maintenant probes téléphone, marqueurs micro/fichier, correction contraste et ergonomie Mode Complet. Release: keystore exclusivement via secrets GitHub, aucune clé dans le dépôt, exact-SHA guard avant signature, apksigner/zipalign/package et suppression du keystore runner. Reste vraie exécution signée + validation appareil réel 0.6.4 avant DONE_VERIFIED.', 'P1'),
