...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.04';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android refondu sur candidate: Jetpack Compose + Material 3, identité visuelle MEL, connexion dédiée, modes Normal / Complet propagés au backend, pairing sans persistance du mot de passe, jeton device Keystore, heartbeat post-pairing, chat/sync ACK/micro Whisper, HTTPS fail-closed. Lot 0.3.0 ajouté: sélecteur OpenDocument, upload privé par jeton device via moteur canonique files/upload, analyse automatique des aperçus texte, état explicite des binaires non extractibles, panneau Complet avec synchronisation et accès Professor. Preuves: PR #167 puis #168 fusionnées; run Android canonique 35850660250 SUCCESS sur a35688fe80046f80781c950fcc3c26a1b1b35b43. Reste validation sur Android réel, notamment auth réelle, fichier réel, micro, Normal/Complet et comportement arrière-plan/notifications avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline CI APK debug canonique renforcé: contrats Android/API avant build, Java 17, Gradle 8.9, Android SDK 35, Compose/Material 3, package fr.veriteinterdite.mel et activité de lancement vérifiés, artefact uploadé; modifications du moteur file-upload déclenchent aussi cette CI. Preuve candidate: run 35850660250 SUCCESS sur a35688fe80046f80781c950fcc3c26a1b1b35b43, artefact 10745476933; APK versionCode 3 / versionName 0.3.0, minSdk 26, targetSdk 35, SHA-256 db111745735a60b8d8eba0203ddc6d8cb1b3621dbb2e08ebacc60da56aef7ba0. Reste signature release par secret protégé, pipeline release versionné et validation sur appareil réel avant DONE_VERIFIED.', 'P1'),
