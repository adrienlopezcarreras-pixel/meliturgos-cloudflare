...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P04', 'Capability Bus, outils et accès au code', [
    ...
    item('GEN2-15', 'Plugin SDK', 'PARTIAL', 'SDK/runtime plugin + registre D1 versionné intégrés: activation durable exige artifact hash + preuves exactes, progresse par le lifecycle canonique, persiste ACTIVE/DISABLED et annule l’activation mémoire si la persistance ACTIVE échoue; identité manifest/artifact immuable et tests D1/runtime dédiés. Reste le loader d’artefacts serveur, le chargement d’une version épinglée au démarrage et le rollback durable avant DONE.', 'P1'),
