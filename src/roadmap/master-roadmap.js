...
export const ROADMAP_REGISTRY_REVISION = '2026-09-25.25';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('MEL-MEM-05', 'Indexation complète messages et pièces jointes', 'IN_PROGRESS', 'Backfill mémoire production désormais certifié sur SHA 78962eca11ed92710479962d7818f82b33890f20 par run 36162716840: 2 808/2 808 messages éligibles synchronisés, remaining_eligible_messages=0 et remaining_conversations=0. Le blocage restant est la complétude de la source pour les pièces jointes: la preuve D1 antérieure suivait 521 conversations, dont 81 partielles et 59 sous-remplies, avec 0 descripteur de pièce jointe et completeness NOT_CONFIRMED. Import serveur/manuel accepte déjà les octets réels bornés, indexe le texte des pièces jointes textuelles et signale les binaires non extractibles sans faux positif. Pour DONE_VERIFIED, réimporter une archive serveur/manuelle plus complète contenant les descripteurs/octets réels puis certifier l’indexation des pièces jointes; ne pas inventer cette preuve à partir de la source actuelle.', 'P0'),
