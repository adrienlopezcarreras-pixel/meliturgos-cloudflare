...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P03', 'Mémoire personnelle et connaissance', [
    ...
    item('GEN2-13', 'Projects / Decisions', 'PARTIAL', 'Contrats projets/décisions/leçons, états, justification, historique de statut, filtres et garde-fous sont implémentés et validés par roadmap-core-memory-ci run 36110560950 SUCCESS. Reste la persistance D1 durable et le branchement CapabilityBus/API avant DONE_VERIFIED.', 'P1'),
    ...
    item('MEL-MEM-03', 'Export mémoire portable et lisible', 'DONE_VERIFIED', 'Export versionné intégré avec manifeste, SHA-256 par mémoire et checksum payload global; round-trip et détection de falsification couverts par tests. Preuve preview isolée: deploy-memory-export-preview run 35005909807 SUCCESS sur 2281407dd6327555f7b7f2ec3dcff35274f1b73f.', 'P1'),
