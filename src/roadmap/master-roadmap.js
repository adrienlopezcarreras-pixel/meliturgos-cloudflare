...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P04', 'Capability Bus, outils et accès au code', [
    ...
    item('GEN2-15', 'Plugin SDK', 'PARTIAL', 'SDK/runtime plugin + registre D1 versionné désormais implémentés: manifeste validé, permissions fail-closed, plugin_versions persistant, identité manifest/artifact immuable, lifecycle canonique avec preuves, lecture/listing et désactivation durable; tests D1 dédiés ajoutés. Reste à brancher le runtime d’activation/loader sur ce registre persistant et résoudre les artefacts serveur avant DONE.', 'P1'),
