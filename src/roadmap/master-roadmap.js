...
export const ROADMAP_REGISTRY_REVISION = '2026-09-23.10';
...
export const MASTER_ROADMAP = Object.freeze([
  ...
  phase('P10', 'Téléphone, PC et appareils', [
    ...
    item('GEN2-27', 'Android Companion runtime / app', 'IN_PROGRESS', 'Runtime natif Android 0.6.2 sur candidate: Jetpack Compose + Material 3, connexion dédiée, modes Normal/Complet, pairing sans persistance du mot de passe, jeton device Keystore, chat/sync ACK/micro Whisper/fichiers HTTPS fail-closed, avatar MEL natif et icône launcher. Arrière-plan: heartbeat WorkManager toutes les 15 min sous contrainte réseau, notifications opt-in, alerte session expirée, annulation à la déconnexion et aucune capture micro cachée. Mode Complet: auto-diagnostic authentifié + copie presse-papiers; 0.6.2 ajoute validation téléphone intégrée: Tester Normal (chat authentifié ui_mode=normal dans une conversation de validation séparée), Tester fichier (upload texte technique + vérification preview_text), Tester arrière-plan (heartbeat immédiat + présence WorkManager + état notifications). La lecture des URI fichiers est désormais réellement bornée à 25 Mo sans readBytes non borné. Preuves post-merge 0.6.2 sur 8d7c825bba127622460347b0a116894eaa421058: android-apk-build 35881379638 SUCCESS et android-emulator-ui-test 35881379918 SUCCESS, captures UI incluses. Preuve appareil réel antérieure 0.6.1 le 2026-09-23: Android SDK 33, Session OK, Heartbeat OK, Mode Complet, backend 0.6.1, device reconnu et Keystore confirmé. Reste validation réelle 0.6.2: lancer Tester Normal, Tester fichier, Tester arrière-plan, test micro matériel et contrôle ergonomie/avatar avant DONE_VERIFIED.', 'P0'),
    item('GEN2-58', 'Build et release Android', 'IN_PROGRESS', 'Pipeline debug canonique et pipeline release signé préparé. Debug 0.6.2: contrats Android/API, Java 17, Gradle 8.9, SDK 35, package/activité, tests UI émulateur, captures réelles et artefact vérifiés; android-apk-build 35881379638 SUCCESS et android-emulator-ui-test 35881379918 SUCCESS sur 8d7c825bba127622460347b0a116894eaa421058; artefact APK 10760429148 et preuve émulateur 10761197737; APK fr.veriteinterdite.mel versionCode 11/versionName 0.6.2, minSdk 26, targetSdk 35, SHA-256 92102e8048efd7710436c0f95ec33115a04141c05fcde5fceae73bc5cabc8ea0. Les commits suivants de candidate ne modifient aucun fichier Android. Installation et exécution réelle 0.6.1 déjà confirmées sur Android SDK 33; 0.6.2 doit maintenant fournir les probes Normal/fichier/arrière-plan et le test micro. Release: keystore exclusivement via secrets GitHub, aucune clé dans le dépôt, exact-SHA guard avant signature, apksigner/zipalign/package et suppression du keystore runner. Reste vraie exécution signée + validation appareil réel 0.6.2 avant DONE_VERIFIED.', 'P1'),
