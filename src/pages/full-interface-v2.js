...
<section class="view" data-panel="terminal"><div class="section-title"><h2>MINI</h2><p>Compagnon physique de MEL · appairage, état et diagnostic de l’ESP32-S3.</p></div><div class="grid"><article class="card"><div class="skill-head"><div><h2>Premier démarrage</h2><p class="muted" style="margin:6px 0 0">Le code d’appairage est valable 10 minutes et ne révèle pas ton mot de passe MEL au terminal.</p></div><span class="tag warn" id="terminalState">EN ATTENTE</span></div><div class="metric" id="terminalPairCode" style="letter-spacing:.12em">— — — —</div><div class="actions"><button class="primary" id="terminalPairCreate">Créer un code d’appairage</button><button id="terminalRefresh">Actualiser</button></div><div class="footer-note" id="terminalPairNote">À la réception : flashe le firmware, connecte-toi au Wi-Fi MEL-SETUP affiché à l’écran puis saisis ce code et ton Wi-Fi.</div></article><article class="card"><h2>Installation / récupération</h2><p class="muted">Le script Windows installera l’outil de flash si nécessaire et utilisera le paquet firmware validé.</p><div class="actions"><a class="button primary" href="/api/device/v1/setup-script">Télécharger le flashage Windows</a></div><div class="status-row"><span>Carte cible</span><strong>ESP32-S3-Touch-LCD-3.5-C</strong></div><div class="status-row"><span>Caméra</span><strong>OV5640</strong></div><div class="status-row"><span>Écran</span><strong>320×480 tactile</strong></div><div class="status-row"><span>Audio</span><strong>ES8311 + micro</strong></div></article><article class="card wide"><h2>Terminaux appairés</h2><div id="terminalDevices"><div class="muted">Chargement des terminaux…</div></div></article><article class="card wide"><h2>Fonctions préparées</h2><div class="status-row"><span>Connexion Wi-Fi + appairage à usage unique</span><span class="tag good">PRÊT</span></div><div class="status-row"><span>Chat MEL</span><span class="tag good">PRÊT BACKEND</span></div><div class="status-row"><span>Micro → transcription française</span><span class="tag good">PRÊT BACKEND</span></div><div class="status-row"><span>Caméra OV5640</span><span class="tag good">COMPILÉ</span></div><div class="status-row"><span>Téléchargement / OTA</span><span class="tag good">COMPILÉ</span></div><div class="status-row"><span>Powerbank USB-C</span><span class="tag good">SANS SOUDURE</span></div><pre class="output" id="terminalOut">MINI v0.2 test · protocole v1.0 · validation physique en cours.</pre></article></div></section>
