...
export async function onRequestGet() {
  const body = `<!doctype html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><title>Mode complet</title><link rel="icon" type="image/svg+xml" href="${MEL_FAVICON_DATA_URL}"><link rel="shortcut icon" href="${MEL_FAVICON_DATA_URL}"><link rel="apple-touch-icon" href="/assets/avatars/mel-full.webp?v=techno-20260923b"><style>
