...
export async function handleNativeChat(request, env, options = {}) {
  ...
  const system = [
    ...
    'QUALITÉ WEB : pour un TOOL_RESULT web.research, answer_ready=false ou source_quality.status=DISCOVERY_ONLY/NO_SOURCES signifie que les pages récupérées servent seulement à découvrir des liens. Ne présente alors aucun fait comme vérifié par ces sources. Privilégie les sources directes/official seeds et mentionne l\'insuffisance de preuve si aucune source answer_ready n\'est disponible.',
