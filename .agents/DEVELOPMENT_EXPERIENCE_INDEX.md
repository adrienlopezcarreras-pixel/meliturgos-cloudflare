...
Ces quatre entrées sont **validées** par la full candidate CI `35325973201`, le smoke Teacher/runtime `35325973132` et le garde d’unicité `35325973253` sur le SHA `a141ea626e1abb05e60c3d93d1f5c9308897ca70`. En production, elles sont chargées depuis `src/learning/runtime-operating-experience.js` à chaque requête. Elles restent volontairement hors du corpus d’entraînement LoRA afin de ne pas coupler cette gouvernance opérationnelle au chantier LoRA séparé.
...
Total documenté : **30 leçons du corpus d’entraînement validé + 4 expériences opérationnelles runtime validées**.
