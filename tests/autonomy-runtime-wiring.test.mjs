...
assert.ok(
  ['src/index.js', 'src/learning-entry.js', 'src/ui-entry.js', 'src/ui-release-fix-entry.js'].includes(mainMatch[1]),
...
if (mainMatch[1] === 'src/ui-entry.js' || mainMatch[1] === 'src/ui-release-fix-entry.js') {
  if (mainMatch[1] === 'src/ui-release-fix-entry.js') {
