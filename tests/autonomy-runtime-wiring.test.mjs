...
assert.ok(
  ['src/index.js', 'src/learning-entry.js', 'src/ui-entry.js', 'src/ui-release-fix-entry.js', 'src/professor-live-learning-entry.js'].includes(mainMatch[1]),
...
if (mainMatch[1] === 'src/professor-live-learning-entry.js') {
...
const usesVerifiedUiChain = ['src/ui-entry.js', 'src/ui-release-fix-entry.js', 'src/professor-live-learning-entry.js'].includes(mainMatch[1]);
if (usesVerifiedUiChain) {
  if (mainMatch[1] === 'src/ui-release-fix-entry.js' || mainMatch[1] === 'src/professor-live-learning-entry.js') {
